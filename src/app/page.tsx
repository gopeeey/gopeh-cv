      ...
      <section className="mx-auto w-full max-w-2xl space-y-12 bg-white print:space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex-1 space-y-1.5">
            ...
            <p className="max-w-md text-pretty font-mono text-base text-primary">
              {RESUME_DATA.about}
            </p>
        ...
        <Section>
          ...
          <div className="flex flex-wrap gap-1 font-mono text-sm text-muted-foreground">
            ...
            return (
              <Card key={work.company}>
                <CardHeader>
                  ...
                  <h4>
                    <a href={work.link} className="font-mono text-sm leading-none hover:underline">
                      {work.company}
                    </a>
                  </h4>
